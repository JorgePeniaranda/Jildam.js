    ...
    return (
        <Container className='flex items-center flex-col'>
            ...
            <div className='w-3/4 h-9 flex justify-center mt-7 mb-3'>
                ...
                <input type='search' placeholder='Buscar' className='w-[60%] dark:text-black placeholder:select-none outline-none py-1 border border-zinc-700 rounded-r-lg border-l-0 text-xl text-center' />
            </div>
